       ...
       if(!empty($this->session->userdata('admin_data'))){
        ...
        redirect("login/admin_login","refresh");
           ...
           $this->form_validation->set_rules('first_name', 'first_name', 'required|xss_clean');
              ...
              $this->form_validation->set_rules('fathers_name', 'fathers_name', 'xss_clean');
							$this->form_validation->set_rules('emial', 'emial', 'xss_clean');
          ...
          $data_insert = array('first_name'=>$first_name,
            'last_name'=>$last_name,
...
$data_insert = array('first_name'=>$fisrt_name,
	'last_name'=>$last_name,
  	'fathers_name'=>$fathers_name,
					'email'=>$email,
					'phone_number'=>$phone_number,
