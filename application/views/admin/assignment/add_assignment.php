...
<td>
<input type="text" name="admin"  class="form-control" placeholder="" required value="" />
</td>
<tr>
...
<select class="form-control" name="student"  >
   ...
   <? foreach ($student_data->result() as $s) {
     ?>
     <option value="<? echo $s->id; ?>"><? echo $s->first_name; ?></option>
     <?
   } ?>
</td>
</tr>
...
<tr>
  ...
  <tr>
    ...
    <tr>
                              <td> <strong>Paid</strong>  <span style="color:red;">*</span></strong> </td>
                              <td>
        <input type="text" name="paid"  class="form-control" placeholder="" required value="" />
                            </td>
      </tr>
      ...
      <tr>
                                ...
                                <td>
          <input type="text" name="pending_amount"  class="form-control" placeholder="" required value="" />
                              </td>
        </tr>
