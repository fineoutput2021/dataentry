                ...
                <div class="table-responsive">
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="text" onkeypress="return isNumberKey(event)" name="total_amount" class="form-control" placeholder="" required value="" />
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="text" onkeypress="return isNumberKey(event)" name="paid" class="form-control" placeholder="" required value="" />
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="text" onkeypress="return isNumberKey(event)" name="pending" class="form-control" placeholder="" required value="" />
                      </td>
                    </tr>
