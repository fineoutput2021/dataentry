      ...
      <div class="col-lg-12">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Update Student </h3>
          </div>
              ...
              <form action="<?php echo base_url() ?>dcadmin/student/add_student_data/<? echo base64_encode(2); ?>/<?= $id ?>" method="POST" id="slide_frm" enctype="multipart/form-data">
                <div class="table-responsive">
                  <table class="table table-hover">
                    ...
                    <tr>
                      <td> <strong>Full_name </strong> <span style="color:red;">*</span></strong> </td>
                      <td>
                        <input type="text" name="full_name" class="form-control" placeholder="" required value="<?= $student->full_name ?>" />
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td> <strong>Country code</strong> <span style="color:red;">*</span></strong> </td>
                      <td>
	...
	<optgroup label="Other countries">
		...
		<option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="text" onkeypress="return isNumberKey(event)" minlength="10" maxlength="10" name="phone" class="form-control" placeholder="" required value="<?= $student->phone_number ?>" />
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="text" name="city" class="form-control" placeholder="" required value="<?= $student->city ?>" />
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="text" name="state" class="form-control" placeholder="" required value="<?= $student->state ?>" />
                      </td>
                    </tr>
