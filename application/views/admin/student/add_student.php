		...
		<div class="row">
          ...
          if (!empty($this->session->flashdata('emessage'))) { ?>
					...
					<div class="panel-body">
						<div class="col-lg-10">
							<form
								action="<?php echo base_url() ?>dcadmin/student/add_student_data/<? echo base64_encode(1); ?>"
								method="POST" id="slide_frm" enctype="multipart/form-data">
								<div class="table-responsive">
									<table class="table table-hover">

										<tr>
											<td> <strong>Student Name</strong> <span
										...
										<tr>
											<td> <strong>Country Code</strong> <span
													style="color:red;">*</span></strong> </td>
											<td>
										...
										<tr>
											<td> <strong>Phone Number</strong> <span
													style="color:red;">*</span></strong> </td>
											<td>
										...
										<tr>
											<td> <strong>Country</strong> <span style="color:red;">*</span></strong>
											</td>
											<td>
