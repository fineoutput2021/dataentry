...
<td> <input type="number" name="phone_number"  class="form-control" placeholder=""  value="<?=$users_data->phone_number;?>" />  </td>
</tr>
<tr>
<td> <strong>Email</strong>  <span style="color:red;">*</span></strong> </td>
<td> <input type="email" name="email"  class="form-control" placeholder=""  value="<?=$users_data->email;?>" />  </td>
</tr>
